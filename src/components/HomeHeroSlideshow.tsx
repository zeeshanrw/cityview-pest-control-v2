...
export default function HomeHeroSlideshow() {
  ...
  return (
    <section className="relative h-[72svh] min-h-[34rem] max-h-[51rem] overflow-hidden bg-ink text-paper md:min-h-[38rem]">
      ...
      <div className="relative mx-auto flex h-full max-w-6xl flex-col justify-center px-4 py-14 md:px-6 md:py-16">
